...
class TR_PrexArgument
   ...
   bool isTypeInfoFromGuard () { return _isTypeInfoFromGuard; }
   void setTypeInfoFromGuard() { _isTypeInfoFromGuard = true; }
